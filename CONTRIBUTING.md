# Contributing
Thank you for your interest in contributing to netapp-openshift-console-protect! 🎉

We appreciate that you want to take the time to contribute! Please follow these steps before submitting your PR.

# Creating a Pull Request

1. Please search [existing issues](https://github.com/NetApp/netapp-openshift-console-protect/issues) to determine if an issue already exists for what you intend to contribute.
2. If the issue does not already exist, [create a new issue](https://github.com/NetApp/netapp-openshift-console-protect/issues/new) that explains the bug or feature request.
...
5. Please wait for feedback from someone on NetApp's Intelligent Operations Services development team before writing any code. We don't really have an SLA for our feedback, but we will do our best to respond in a timely manner (at least to inform if you are on the right track and that you should proceed, or not).
...
- For **Project Name**, select "Other" from the dropdown.
- In **Project Website**, enter: https://github.com/NetApp/netapp-openshift-console-protect
...
# NetApp Intelligent Operations Services Team's Commitment
While we truly appreciate your efforts on pull requests, we **cannot** make any commitment for when, or if, your PR will be included in the netapp-openshift-console-protect project. Here are a few reasons why:
...
Thank you for considering to contribute to netapp-openshift-console-protect!
